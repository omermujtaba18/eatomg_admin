                            ...
                            <div class="datatable table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($inventory_category)) : ?>

                                            <?php foreach ($inventory_category as $category) : ?>

                                                <tr>
                                                    <td><?= esc($category['inventory_category_id']); ?></td>
                                                    <td><?= esc($category['inventory_category_name']); ?></td>
                                                    <td>

                                                        <a class="btn btn-icon btn-sm btn-yellow ml-2 text-white" href="category/update/<?= esc($category['inventory_category_id']); ?>">
                                                            <i data-feather="edit"></i></a>
                                                        <a class="btn btn-icon btn-sm btn-red ml-2 text-white" href="category/delete/<?= esc($category['inventory_category_id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
