                        ...
                        <div class="card-body">
                            <form method="post" class="col" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="restaurant[0]" name="restaurant[]" type="checkbox" value="OMG - North Avenue">
                                                <label class="custom-control-label" for="restaurant[0]">
                                                    OMG - North Avenue
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="restaurant[1]" name="restaurant[]" type="checkbox" value="OMG - Van Buren">
                                                <label class="custom-control-label" for="restaurant[1]">
                                                    OMG - Van Buren
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="restaurant[2]" name="restaurant[]" type="checkbox" value="OMG - Catering">
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label>Customer Buy Type</label>
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="buyType[0]" name="buyType[]" type="checkbox" value="Website">
                                                <label class="custom-control-label" for="buyType[0]">
                                                    Website
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="buyType[1]" name="buyType[]" type="checkbox" value="App">
                                                <label class="custom-control-label" for="buyType[1]">
                                                    App
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox custom-control-solid">
                                                <input class="custom-control-input" id="buyType[2]" name="buyType[]" type="checkbox" value="Walk-ins">
